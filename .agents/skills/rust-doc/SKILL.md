...
- When a file already has doc comments, match their established terminology and structural choices (bullets vs. prose for a short error list, how a repeated domain noun is named) instead of introducing a second convention beside them.
...
- [ ] New doc comments in an already-documented file match its established terminology and structural choices rather than introducing a second convention.
