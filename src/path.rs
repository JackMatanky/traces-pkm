//! Validate relative paths, confine them to a root, and serialize them with
//! platform-native encodings.
//!
//! Main types:
...
//! - [`codec`] - Serde support for `PathBuf` fields in serialized formats
//!
