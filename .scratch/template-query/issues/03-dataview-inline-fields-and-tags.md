...
**Status sync (2026-08-01):** corrected `ready-for-agent` → `completed` — the Implementation Notes below confirm this landed on `main` (`src/note/` inline-field lexer, tags, frontmatter parsing). The acceptance criteria above were already checked; only the `Status:` field had drifted.
