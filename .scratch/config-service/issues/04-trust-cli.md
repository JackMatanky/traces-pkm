...
- **Thin CLI layer (m05):** the command handlers should be thin adapters over the trust store API from issue 03 — parse args, call `trust()`/`is_trusted()`/list/clean, format output. No trust logic in the CLI layer.
