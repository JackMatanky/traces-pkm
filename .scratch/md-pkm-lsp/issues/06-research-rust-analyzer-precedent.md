...
Write findings to `.scratch/md-pkm-lsp/research/tool-rust-analyzer-precedent.md`, citing each claim's source (file + section). This ticket answers "what does the pattern look like and what does it cost", not "should Traces adopt it" — that decision belongs to the architecture tickets it unblocks.
...
Full findings: [`research/tool-rust-analyzer-precedent.md`](../research/tool-rust-analyzer-precedent.md)
