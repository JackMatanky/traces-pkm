...
This project is indexed by GitNexus as **traces-pkm** (2943 symbols, 6723 relationships, 230 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
