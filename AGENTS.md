...
This project is indexed by GitNexus as **traces-pkm** (5861 symbols, 16333 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
