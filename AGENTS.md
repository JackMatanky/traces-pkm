...
This project is indexed by GitNexus as **traces-pkm** (5638 symbols, 15676 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
