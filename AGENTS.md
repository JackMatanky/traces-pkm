...
This project is indexed by GitNexus as **traces-pkm** (4305 symbols, 11573 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
