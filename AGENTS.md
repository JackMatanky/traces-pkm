...
This project is indexed by GitNexus as **traces-pkm** (2473 symbols, 6793 relationships, 218 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
