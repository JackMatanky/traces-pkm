...
This project is indexed by GitNexus as **traces-pkm** (1900 symbols, 5274 relationships, 167 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
