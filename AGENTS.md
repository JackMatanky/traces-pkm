...
This project is indexed by GitNexus as **traces-pkm** (3772 symbols, 8895 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
