...
This project is indexed by GitNexus as **traces-pkm** (2960 symbols, 6837 relationships, 239 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
